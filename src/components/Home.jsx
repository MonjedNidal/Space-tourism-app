...
function Home({ setOpenedPage }) {
  return (
    <div className="flex flex-col xl:flex-row text-center justify-evenly content-center flex-wrap pt-28 bg-backgroundHomeMobile md:bg-backgroundHomeTablet xl:bg-backgroundHomeDesktop min-h-screen bg-no-repeat bg-center bg-cover overflow-y-hidden xl:justify-around xl:">
      <div>
        ...
        <p className="text-textGray mb-6 px-6 max-w-md md:leading-[1.75rem] xl:leading-8	xl:text-[1.125rem]">
